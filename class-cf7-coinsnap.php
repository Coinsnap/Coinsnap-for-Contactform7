...
{            
    ...
    function cf7_coinsnap_admin_after_additional_settings($cf7)
	{
		...
		$admin_settings = '<div class="coinsnap-settings"><table class="form-table"><tbody>';
        $admin_settings .= '<tr><td width="270"><label>Enable Coinsnap on this form</label></td><td><input type="checkbox" value="1" name="coinsnap_enable" '.$checked.'></td></tr>';   
        $admin_settings .= '<tr><td><label>Amount Field Name (required)</label></td><td><input type="text" value="'.$amount_field.'" name="coinsnap_amounts"></td></tr>';             
        $admin_settings .= '<tr><td><label>Name Field Name</label></td><td><input type="text" value="'.$name_field.'" name="coinsnap_name"></td></tr>';                     
        $admin_settings .= '<tr><td><label>E-Mail Field Name </label></td><td><input type="text" value="'.$email_field.'" name="coinsnap_email"></td></tr>';
        $admin_settings .= '<tr><td class="coinsnap-payment-title" colspan="2"><hr></td></tr>';
        $admin_settings .= '<tr><td><label>Currency Code (required)</label></td><td><input type="text" value="'.$coinsnap_currency.'" name="coinsnap_currency"></td></tr>';
        $admin_settings .= '<tr><td class="coinsnap-payment-label"><label>Store ID (required)</label></td><td class="coinsnap-payment-label"><input type="text" value="'.$coinsnap_store_id.'" name="coinsnap_store_id"></td></tr>';
        $admin_settings .= '<tr><td class="coinsnap-payment-label"><label>API Key (required)</label></td><td class="coinsnap-payment-label"><input type="text" value="'.$coinsnap_api_key.'" name="coinsnap_api_key"></td></tr>';        
        $admin_settings .= '<tr><td class="coinsnap-payment-label"><label>Success URL (required)</label></td><td class="coinsnap-payment-label"><input type="text" value="'.$coinsnap_s_url.'" name="coinsnap_s_url"></td></tr>';                
        

        $admin_settings .= '<input type="hidden" name="post" value="'.$post_id.'"></tbody></table></div>';
